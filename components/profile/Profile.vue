...
const profile = {
  jp: "1996年広島生まれ．筑波大学大学院図書館情報メディア研究科所属．徳山高専で情報電子を学んだあと，筑波大学に編入．2017年（当時学部3年）からピクシーダストテクノロジーズ株式会社でフルタイムのリサーチエンジニアとして，網膜投影ディスプレイおよび網膜撮像カメラの画像処理技術の開発に従事．学業と仕事を両立しながら2019年筑波大学大学院に進学．2020年にピクシーダストを退職した後，独立して，高品質なテロップを自動で生成するサービス「telorain.com」をリリース．経済産業省所轄の情報処理推進機構より，2019年度未踏事業を通じてスーパクリエータ認定を受ける．",
