module.exports = {
  head: {
    ...
    meta: [
      ...
      { hid: 'og:url', property: 'og:url', content: 'http://kazukiotao.com/' },
      ...
      { hid: 'og:image', property: 'og:image', content: 'http://kazukiotao.com/profile/portrait/img01.jpg' },
      { name: 'twitter:card', content: 'summary' },
      { name: 'twitter:site', content: '@0meo' },
      { name: 'twitter:title', content: '大峠和基 / Kazuki Otao' },
      { name: 'twitter:url', content: 'http://kazukiotao.com/' },
      { name: 'twitter:image', content: 'http://kazukiotao.com/profile/portrait/img01.jpg' },
